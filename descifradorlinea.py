...
filename = open('gpsInfo.txt' , encoding='utf-8')
salida = open('decode.txt', 'w+')
coordenadas = open('coordenadas.txt', 'w+') # a día 30/4/21 funcionaba con nombre de archivo de salida coordenadas,txt cambiado a coordenadas.txt
